...
public class menu {
	...
	public static Integer principal(Scanner teclado) {
		System.out.println("===============================");
	...
	public static void escolhaDaCategoria() {
		System.out.println("===============================");
	...
	public static void confirmacaoEF(Scanner teclado, int i, List famosos) {
		System.out.println("===============================");
		...
		case "sim":
			...
			i = 0;
			escolhedor.perguntasFamosos(teclado, i);
	...
	public static void perguntafamosos(String question, Scanner teclado, int i, List famosos) {
		...
		switch(question) {
			case "1":
				...
				System.out.println("1 - Rio de Janeiro | 2 - Rio Grande do Sul | 3 - Santa Catarina | 4 - Goiás");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
						...
						break;
					default:
						menu.confirmacaoEF(teclado, i, famosos);
						break;
				}
				break;
			...
			case "2":
				...
				System.out.println("1 - Gauchinha | 2 - Paulistinha | 3 - Pimentinha | 4 - Andorinha");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "3":
				...
				System.out.println("1 - Raul Gil | 2 - Bolinha | 3 - Flávio Cavalcanti | 4 - Chacrinha");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 4:
			...
			case "4":
				...
				System.out.println("1 - Sibrinha | 2 - Wanderleia | 3 - Gretchen | 4 - Martinha");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "5":
				...
				System.out.println("1 - Leonardo | 2 - Xororó | 3 - Zezé Di Camargo | 4 - Chitãozinho");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "6":
				...
				System.out.println("1 - Maurício de Sousa | 2 - Ziraldo | 3 - Monteiro Lobato | 4 - Machado de Assis");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "7":
				...
				System.out.println("1 - Frank Sinatra | 2 - Little Richard | 3 - Elvis Presley | 4 - Rickei Valens");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "8":
				...
				System.out.println("1 - Tiozinha | 2 - Feiticeira | 3 - Lady Lu | 4 - Sheila Mello");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "9":
				...
				System.out.println("1 - Penadinho | 2 - Zé do Caixão | 3 - Zé do Casarão | 4 - Toninho do Diabo");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "10":
				...
				System.out.println("1 - Zagallo | 2 - Scolari | 3 - Luxemburgo | 4 - Carpegianni");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 1:
			...
			case "11":
				...
				System.out.println("1 - Graham Bell | 2 - George Washingtom | 3 - Thomas Edisom | 4 - Marconi");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 1:
			...
			case "12":
				...
				System.out.println("1 - Engraxate | 2 - Pedreiro | 3 - Feirante | 4 - Metalúrgico");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 4:
			...
			case "13":
				...
				System.out.println("1 - Paraíba | 2 - Ceará | 3 - Bahia | 4 - Alagoas");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 1:
			...
			case "14":
				...
				System.out.println("1 - Orlando Silva | 2 - Vicente Celestino | 3 - Francisco Alves | 4 - Carlos Gollardo");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "15":
				...
				System.out.println("1 - Cameron Diaz | 2 - Kate Winslet | 3 - Bridget Fonda | 4 - Catherine Zetta Jones");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "16":
				...
				System.out.println("1 - Sancho Pança | 2 - Guilherme Tell | 3 - Sigmund Freud | 4 - Lan Celot");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 1:
			...
			case "17":
				...
				System.out.println("1 - Lilico | 2 - Roni Cócegas | 3 - Grande Otelo | 4 - Mazzaropi");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "18":
				...
				System.out.println("1 - Leonardo da Vinci | 2 - Ticiano | 3 - Rafael | 4 - Michelângelo");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 1:
			...
			case "19":
				...
				System.out.println("1 - Pelé | 2 - João Havelange | 3 - Charles Miller | 4 - Paulo Machado");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "20":
				...
				System.out.println("1 - Glenda Jackson | 2 - Margaret Becket | 3 - Marilyn Monroe | 4 - Elizabeth Taylor");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "21":
				...
				System.out.println("1 - Cantora | 2 - Escritora | 3 - Arquiteta | 4 - Pianista");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 2:
			...
			case "22":
				...
				System.out.println("1 - Leonardo | 2 - Chitãozinho | 3 - Daniel | 4 - Vinny");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 3:
			...
			case "23":
				...
				System.out.println("1 - Tobias Barreto | 2 - Dorival Caymmi | 3 - Machado de Assis | 4 - Castro Alves ");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 4:
			...
			case "24":
				...
				System.out.println("1 - Márcio Quintana | 2 - Manuel Bandeira | 3 - Vinícius de Morais | 4 - Carlos Drummond");
				System.out.println("===============================");
				um = teclado.nextInt();
				switch(um) {
					case 4:
